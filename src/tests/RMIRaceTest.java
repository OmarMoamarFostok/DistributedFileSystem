...
//                    Thread.sleep(1000);
    ...
    public static void main(String[] args) throws Exception {
        // Lookup node stub from RMI registry
...
//        test.deleteRaceTest("qa","pool-1-thread-1");
        ...
        // Now ask node for metaFiles count of the uploaded file
//        int count = node.getMetaCount("department/filename"); // implement this accessor
//        System.out.println("Meta count after concurrent uploads: " + count);
    }
}
